 ...
 */
final class Version20221101080921 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE EndUser CHANGE email email VARCHAR(150) NOT NULL, CHANGE password password INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE EndUser CHANGE email email TINYTEXT NOT NULL, CHANGE password password VARCHAR(255) NOT NULL');
