 ...
 */
final class Version20221028062345 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE EndUser DROP email, DROP roles, DROP password');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE EndUser ADD email TINYTEXT NOT NULL, ADD roles JSON NOT NULL, ADD password VARCHAR(255) NOT NULL');
