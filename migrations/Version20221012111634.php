 ...
 */
final class Version20221012111634 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649C7A377B3 FOREIGN KEY (blood_groupid) REFERENCES bloodgroup (id) ON DELETE CASCADE');
