 ...
 */
final class Version20221104051642 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE blood_group (id INT AUTO_INCREMENT NOT NULL, blood_group LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('DROP TABLE bloodgroup');
        $this->addSql('DROP TABLE end_user');
        $this->addSql('ALTER TABLE EndUser CHANGE email email VARCHAR(150) NOT NULL');
        $this->addSql('ALTER TABLE phonenumber CHANGE phone_number phone_number INT NOT NULL, CHANGE users_id users_id INT NOT NULL');
        $this->addSql('ALTER TABLE phonenumber ADD CONSTRAINT FK_EFF286D267B3B43D FOREIGN KEY (users_id) REFERENCES user (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D6495F3AECE2 FOREIGN KEY (blood_group_id) REFERENCES blood_group (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bloodgroup (id INT AUTO_INCREMENT NOT NULL, blood_group LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE EndUser CHANGE email email TINYTEXT NOT NULL');
