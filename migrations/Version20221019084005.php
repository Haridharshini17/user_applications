 ...
 */
final class Version20221019084005 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE phonenumber CHANGE users_id users_id INT DEFAULT NULL, CHANGE phone_number phone_number JSON NOT NULL');
