 ...
 */
final class Version20221102181632 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE phonenumber DROP FOREIGN KEY phonenumber_ibfk_1');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE phonenumber ADD CONSTRAINT phonenumber_ibfk_1 FOREIGN KEY (users_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
