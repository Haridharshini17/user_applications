 ...
 */
final class Version20221019084303 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE phonenumber CHANGE users_id users_id INT DEFAULT NULL, CHANGE phone_number phone_number INT DEFAULT NULL');
