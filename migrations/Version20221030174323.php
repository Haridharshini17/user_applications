 ...
 */
final class Version20221030174323 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE apitoken ADD CONSTRAINT FK_23E5A7D3A76ED395 FOREIGN KEY (user_id) REFERENCES EndUser (id)');
